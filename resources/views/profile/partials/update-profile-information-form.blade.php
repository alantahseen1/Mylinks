<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">{{ __('Your public page: ') . url('/') . '/' }}{{ old('username',
                $user->username) }}</p>
        ...
        <div>
            ...
            <textarea id="bio" name="bio" rows="3"
                ...
                placeholder="{{ __('Tell visitors about yourself...') }}">{{ old('bio', $user->bio) }}</textarea>
        ...
        <div>
            ...
            <div class="mt-2 flex items-center gap-4">
                ...
                <span class="text-sm text-gray-500">{{ __('Current image') }}</span>
            </div>
            @endif
